...
# 9 are rotated 180 degrees, they become 0, 1, 9, 8, 6 respectively. When 2, 3, 4,
# 5 and 7 are rotated 180 degrees, they become invalid. A confusing number is a number
...
class Solution:
    def confusingNumber(self, N: int) -> bool:
        ...
        res = []
        for s in S[::-1]:
            if s not in rotation:
                return False
            res.append(rotation[s])
        return "".join(res) != S
