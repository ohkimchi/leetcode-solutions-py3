...
# n + 2 candies to the second person, and so on until we give 2 * n candies to the last
# person.
#
# This process repeats (with us giving one more candy each time, and moving to the
# start of the row after we reach the end) until we run out of candies. The last person
# will receive all of our remaining candies (not necessarily one more than the previous
# gift).
#
