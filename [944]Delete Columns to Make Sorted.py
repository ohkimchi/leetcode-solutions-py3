...
# 3}, then the final array after deletions is ["bef", "vyz"], and the remaining columns
# of A are ["b","v"], ["e","y"], and ["f","z"]. (Formally, the c-th column is [A[0][c],
...
# If we chose D = {}, then a column ["b","a","h"] would not be in non-decreasing sorted
# order.
# 
#
# 
